...
const swSolicitudOrganizacionRoutes = require('./swSolicitudOrganizacionRoutes');
...
const swProveedorExternoRoutes = require('./swProveedorExternoRoutes');
...
router.use('/api/sw', swSolicitudOrganizacionRoutes);
...
router.use('/api/sw', swProveedorExternoRoutes);
